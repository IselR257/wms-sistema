...
comprasRouter.get("/ordenes", asyncHandler(async (_req, res) => {
...
comprasRouter.post("/ordenes", requirePermission("Compras"), asyncHandler(async (req, res) => {
        ...
        data: {
            ...
            detalles: {
                create: data.detalles.map((detalle) => ({
                    ...
                    precioUnitario: typeof detalle.precioUnitario === "number"
...
comprasRouter.post("/recepciones", requirePermission("Recepciones"), asyncHandler(async (req, res) => {
