...
inventarioRouter.get("/", asyncHandler(async (_req, res) => {
...
inventarioRouter.get("/movimientos", asyncHandler(async (_req, res) => {
...
inventarioRouter.post("/entrada", requirePermission("Inventario", "Ajustes operativos"), asyncHandler(async (req, res) => {
...
inventarioRouter.post("/salida", requirePermission("Inventario", "Ajustes operativos"), asyncHandler(async (req, res) => {
...
inventarioRouter.post("/ajuste", requirePermission("Ajustes operativos", "Inventario"), asyncHandler(async (req, res) => {
