...
import { DEFAULT_ROLE_DEFINITIONS, PERMISSION_OPTIONS, ensureRoleConfigurations, listRoleConfigurations, normalizePermissions } from "../../lib/permissions.js";
...
rolesRouter.get("/configuraciones", requirePermission("Roles"), asyncHandler(async (_req, res) => {
    res.json(await listRoleConfigurations());
}));
rolesRouter.patch("/configuraciones/:rol", requireRole(RolUsuario.ADMIN), asyncHandler(async (req, res) => {
